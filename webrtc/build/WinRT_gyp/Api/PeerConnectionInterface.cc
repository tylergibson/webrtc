	...
	namespace WebRtc {
		...
		namespace globals {
			...
			private:
				...
				rtc::scoped_refptr<rtc::FileStream> fileStream_;
			};
			...
			rtc::scoped_refptr<rtc::LoggingServer> gLoggingServer;
			rtc::scoped_refptr<FileLogSink> gLoggingFile;
		...
		IAsyncAction^ RTCPeerConnection::SetLocalDescription(
			...
			return CreateCallbackBridge(
				...
				rtc::scoped_refptr<webrtc::SessionDescriptionInterface> nativeDescription;
		...
		IAsyncAction^ RTCPeerConnection::AddIceCandidate(RTCIceCandidate^ candidate) {
			return Concurrency::create_async([this, candidate] {
				globals::RunOnGlobalThread<void>([this, candidate] {
					...
					rtc::scoped_refptr<webrtc::IceCandidateInterface> nativeCandidate;
		...
		void WebRTC::EnableLogging(LogLevel level) {
			...
			globals::gLoggingServer = rtc::scoped_refptr<rtc::LoggingServer>(
			...
			globals::gLoggingFile = rtc::scoped_refptr<globals::FileLogSink>(
